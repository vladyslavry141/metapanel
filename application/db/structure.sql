...
CREATE TABLE "Todo" (
  ...
  "data" varchar NOT NULL CHECK ("Todo"."data" <> ''),
...
ALTER TABLE "Todo" ADD CONSTRAINT "fkTodoCreatedBy" FOREIGN KEY ("createdBy") REFERENCES "SystemUser" ("systemUserId");
ALTER TABLE "Todo" ADD CONSTRAINT "fkTodoCreatedFor" FOREIGN KEY ("createdFor") REFERENCES "SystemUser" ("systemUserId");
